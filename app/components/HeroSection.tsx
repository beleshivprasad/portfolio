        ...
        >
          <div className="space-y-3 md:space-y-4 mb-6 md:mb-8">
            ...
            <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto">
              Full Stack Software Engineer with 3 years of experience in
              scalable web app development. Proficient in React.js, Next.js
              (frontend), and Node.js, Express (backend). Experienced in API
              design, UI/UX, clean coding practices, and team collaboration.{" "}
            </p>
            <p className="text-base md:text-lg text-gray-500 max-w-2xl mx-auto">
              Software Enginner at <span className="text-blue-400">Josh Software Pvt Ltd</span>
            </p>
          </div>
