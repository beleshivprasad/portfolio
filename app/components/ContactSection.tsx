      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a
              href="mailto:shivprasad.m.bele@gmail.com"
            ...
            <a
              href="https://drive.google.com/file/d/1qmQET4-dQC7LYnIfY-VG7agcg15odycV/view?usp=sharing"
              target="_blank"
          ...
          <div className="flex justify-center gap-6">
            <a
              href="https://github.com/beleshivprasad"
              target="_blank"
            ...
            <a
              href="https://linkedin.com/in/beleshivprasad"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-white transition-colors p-2 hover:bg-gray-800 rounded-lg"
            >
